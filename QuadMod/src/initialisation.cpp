...
void InitSAI()
{
	...
	RCC->CCIPR5 |= RCC_CCIPR5_SAI1SEL_0;		// 000: pll1_q_ck; 001: pll2_p_ck; 010: pll3_p_ck; 011: AUDIOCLK; 100: per_ck
	...
	SAI1_Block_A->CR1 |= 0xa << SAI_xCR1_MCKDIV_Pos;	// This looks incorrect; we want 12.288MHz; this gives 12.8MHz
	SAI1_Block_A->CR1 |= SAI_xCR1_MCKEN;				// Enable Master clock output

	SAI1_Block_A->FRCR |= (31 << SAI_xFRCR_FRL_Pos);	// Set Frame size to 32 bits
	...
	//SAI1_Block_A->SLOTR &= ~SAI_xSLOTR_SLOTSZ_0;		// 00: Slot size = DS data size; 01: 16-bit; 10: 32-bit
	//SAI1_Block_A->SLOTR &= ~SAI_xSLOTR_NBSLOT;		// Number of slots = 1
	SAI1_Block_A->SLOTR |= SAI_xSLOTR_SLOTEN;			// FIXME - enable all slots for now

	SAI1_Block_B->CR1 |= SAI_xCR1_MODE;					// 00: Master transmitter; 01: Master receiver; 10: Slave transmitter; 11: Slave receiver
	...
	SAI1_Block_B->CR1 |= SAI_xCR1_SYNCEN;				// 00: asynchronous mode; 01: synchronous with internal subblock; 10: synchronous with external SAI
	SAI1_Block_B->CR1 |= SAI_xCR1_MCKEN;				// Enable Master clock output
